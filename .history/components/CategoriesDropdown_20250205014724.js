      ...
      <Center>
        <Wrapper>
          ...
          <StyledNav open={menuOpen}>
            ...
            <NavLink as="button" onClick={() => setSubmenuOpen(!submenuOpen)}>
              Kategorije {submenuOpen ? <FaChevronUp /> : <FaChevronDown />}
            </NavLink>
            <Submenu open={submenuOpen}>
              <NavLink href="/categories/varalice">Varalice</NavLink>
              <NavLink href="/categories/majice">Majice</NavLink>
            </Submenu>
