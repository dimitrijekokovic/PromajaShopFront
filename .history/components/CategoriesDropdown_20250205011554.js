...
export default function CategoriesDropdown() {
  ...
  const handleMouseEnter = (e) => {
    e.stopPropagation();
    console.log("Hover nad kategorijama"); // Debugging
  ...
  const handleMouseLeave = (e) => {
    e.stopPropagation();
    console.log("Miš napustio kategorije"); // Debugging
  ...
  const handleMouseLeave = () => {
    e.stopPropagation();
    console.log("Miš napustio kategorije"); // Provera da li se event dešava
    timeoutId = setTimeout(() => setIsOpen(false), 50);
  };
