...
const ImageWrapper = styled.div`
  width: 100%; /* Prilagodljivo na sve ekrane */
  max-width: 400px; /* Maksimalna veličina slike */
  height: auto;
  display: flex;
  justify-content: center;
  align-items: center;
  ...
  img {
    width: 100%;
    height: auto;
    max-height: 300px; /* Sprečava preveliku visinu na većim ekranima */
    object-fit: contain; /* Sprečava sečenje slike */
  }

  @media (max-width: 768px) {
    max-width: 250px; /* Smanjena veličina slike za mobilne uređaje */
    img {
      max-height: 250px;
    }
  }
        ...
        <ColumnsWrapper>
          ...
          <Column>
            ...
            <Desc>
              ...
              <ButtonsWrapper>
              <ButtonLink href={`/product/67c32036ab2b05caf679b6ad`} outline={1} white={1} size="l">
              Saznaj više
                </ButtonLink>
