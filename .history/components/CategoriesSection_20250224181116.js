    ...
    <Center>
      ...
      <CategoriesContainer>
        ...
        <CategoryItem area="cat4" onClick={() => handleCategoryClick("silikonci")}>
          <Image src="/silikonci.png" alt="Silikonci" width={150} height={150} style={{ objectFit: "contain" }}/>
          <h3>Silikonci</h3>
        </CategoryItem>
        <CategoryItem area="cat5" onClick={() => handleCategoryClick("majice")}>
          <Image src="/majice.png" alt="Majice" width={150} height={150} style={{ objectFit: "contain" }}/>
          <h3>Majice</h3>
        </CategoryItem>
