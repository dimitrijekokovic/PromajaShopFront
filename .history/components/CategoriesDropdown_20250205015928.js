...
const MobileMenu = styled.div`
  position: fixed; /* Prethodno je bilo relative */
  top: 0;
  left: 0;
  width: 100%;
  height: 100%;
  ...
  color: #fff;
  z-index: 99999; /* Osiguraj da je na vrhu */
  overflow-y: auto;
  padding: 20px;
  display: flex;
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        console.log("Učitane kategorije:", data); // Log da vidimo da li podaci dolaze u React
        setCategories(data);
      } catch (error) {
