...
const DropdownMenu = styled.ul`
  ...
  z-index: 9999;
  width: 250px;
  opacity: ${(props) => (props.$isOpen ? "1" : "0")}; /* Umesto display */
  visibility: ${(props) => (props.$isOpen ? "visible" : "hidden")}; /* Poboljšava tranziciju */
...
export default function CategoriesDropdown() {
  ...
  const handleMouseLeave = () => {
    console.log("🔴 Miš napustio Kategorije - Zatvaram meni");
  ...
  return (
    <>
      ...
      >
        ...
        <DropdownMenu key={isOpen} $isOpen={isOpen}>{renderMenuItems()}</DropdownMenu>
      </DropdownContainer>
