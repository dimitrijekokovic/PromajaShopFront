...
export default function AboutUs() {
  return (
    <>
      ...
      <Testimonial>
        <h3>Šta kažu naši korisnici?</h3>
        <p>
          "PromajaFishing mi je promenila način na koji gledam pecanje. Od proizvoda do saveta, sve je savršeno!
          Hvala na inspiraciji!" - <span>Milan Jovanović</span>
        </p>
        <p>
          "PF Vobler je zaista neverovatan! Rezultati su bili fantastični, a podrška tima je izuzetna." -{" "}
