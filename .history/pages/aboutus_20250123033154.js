...
const SwiperContainer = styled.div`
  ...
  .swiper-slide img {
    width: 100%; /* Širina slike prilagođena containera */
    height: 700px; /* Zadrži visinu za desktop */
  ...
  @media (max-width: 768px) {
    .swiper-slide img {
      height: 200px; /* Smanji visinu samo za mobilne uređaje */
      object-position: center top; /* Fokusiraj gornji deo slike za mobilne */
    }
  }
`;
