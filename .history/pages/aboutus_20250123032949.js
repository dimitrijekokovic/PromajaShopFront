...
const Text = styled.p`
  ...
  @media (max-width: 768px) {
    font-size: 1.2rem; /* Smanji font za mobilne uređaje */
    padding: 0 15px; /* Dodaj padding za bolju čitljivost na manjim ekranima */
  }
`;
...
const SwiperContainer = styled.div`
  max-width: 90%; /* Dodaj marginu sa strane */
  margin: 50px auto; /* Centriraj slideshow i dodaj prostor gore i dole */
  border-radius: 15px;
  overflow: hidden;

  .swiper-slide img {
    width: 100%;
    height: 300px; /* Fiksna visina za pravougaoni oblik */
    object-fit: cover; /* Centriraj sliku unutar okvira */
    object-position: center top; /* Gurni sliku gore da se bolje vidi riba */
    border-radius: 10px; /* Zaobljeni uglovi */
  }

  @media (max-width: 768px) {
    max-width: 95%; /* Još veći prostor za mobilne uređaje */
    .swiper-slide img {
      height: 250px; /* Manja visina za mobilne uređaje */
    }
  }
`;
...
const ImageBanner = styled.div`
  ...
  &:before {
    ...
    @media (max-width: 768px) {
    height: 300px; /* Manja visina za mobilne uređaje */
  }
`;
...
const BannerText = styled.div`
  ...
  p {
    ...
    @media (max-width: 768px) {
    h1 {
      font-size: 2rem; /* Još manji naslov za vrlo male uređaje */
    }
    p {
      font-size: 1rem;
    }
