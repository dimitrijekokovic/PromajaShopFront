...
const InfoBar = styled.div`
  ...
  @media (max-width: 768px) {
    flex-direction: column;
    gap: 10px;
    margin: 0; /* Uklanja višak margina */
    padding: 0 10px; /* Dodaje unutrašnji razmak sa obe strane */
  }
`;
...
const InfoBox = styled.div`
  ...
  @media (max-width: 768px) {
    ...
    width: 100%; /* Osigurava da popunjava celu širinu */
  }
`;
...
export default function CartPage() {
    ...
    const { cartProducts, addProduct, removeProduct, clearCart, user, setUser } =
