...
const ImageBanner = styled.div`
  ...
  background-size: contain; /* Umesto 'cover' koristi 'contain' za bolju vidljivost cele slike */
  ...
  &:before {
    ...
    width: 100%;
    height: 100%;
    background: rgba(0, 0, 0, 0.4); /* Zadržava se tamni sloj za čitljivost teksta */
    top: 0;
    left: 0;
  }
`;
